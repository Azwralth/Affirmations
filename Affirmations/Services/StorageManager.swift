...
struct Storage {
    static var sampleItems: [Item] = [
        Item(title:"Для девушек", image: "pic-5", description: "Есть ряд высказываний, которые не относятся к конкретной сфере жизни, но могут зарядить вас энергией и уверенностью.", affirmation: femaleAffirmations, isFavorite: false),
        Item(title: "Для мужчин",image: "pic-6", description: "Аффирмации помогают представителям сильного пола быстро преодолевать внутренние барьеры, которые мешают достигнуть цели. Самые лучшие позитивные высказывания приводим ниже. ", affirmation: maleAffirmations, isFavorite: false),
    ...
    static let femaleAffirmations = [
        Affirmation(text: "Если человек заболел и нахохлился, то можно сказать, что он хворобушек."),
        Affirmation(text: """
Какой звук издаётся при поцелуе татарина? 
                    
"Эчпочмок"
"""),
        Affirmation(text: "Самый сексуальный изгиб на теле женщины это кисть, держащая баночку пива."),
        Affirmation(text: "Я приношу радость в этот мир."),
        Affirmation(text: "Как же глупенько с твоей стороны забыть, что ты и есть любовь всей своей жизни."),
        Affirmation(text: "Настроение: тратить деньги, пить кофе и красиво одеваться."),
        Affirmation(text: "От финансовой подушки у тебя только наволочка."),
        Affirmation(text: "Ты должна найти себе мужика. Котам нужен отец."),
        Affirmation(text: "Уже в том возрасте, когда мастера по ногтям страшнее потерять, чем мужика."),
        Affirmation(text: "Ты как будто бы специально блять лучше всех"),
        Affirmation(text: "Запомни, чужое мнение создано для того, чтобы ебать его в рот."),
        Affirmation(text: "Тяжело смотреть на губы, которые несут хуйню."),
        Affirmation(text: "Милая моя, бриллиантам прощаются острые грани."),
        Affirmation(text: "Главная цель в жизни — быть залюбленной, избалованной и в жопу зацелованной."),
        Affirmation(text: "Счастье любит не тишину, а когда он блять умеет нормально фотографировать."),
        Affirmation(text: "Главное не превратиться после праздников из xs в xl."),
        Affirmation(text: "После того, что этот год с тобой сделал, он обязан на тебе жениться."),
        Affirmation(text: "Всё на хую не перевертеть, но к этому нужно стремиться."),
        Affirmation(text: "Лучшая работа та, которой нет."),
        Affirmation(text: "Если не можешь похудеть, сделай так, чтобы твои подруги поправились."),
        Affirmation(text: "Ты разбаловала себя уже до такой степени, что сама себя уже не тянешь."),
        Affirmation(text: """
                    "Девочка: з — забота
                    Женщина: з — заблокировать.
"""),
        Affirmation(text: "На новый год хорошие мужчины наряжают ёлку, а очень хорошие — свою женщину."),
        Affirmation(text: "Всё нормально. Просто день тяжелый."),
        Affirmation(text: "Идеальные отношения — это когда вы орёте не друг на друга, а друг на друге."),
        Affirmation(text: "Мешки под глазами — это спасательные круги, чтобы они не утонули в твоих красивых глазах."),
        Affirmation(text: "Найти мужика, чтобы забыть другого мужика — это как взять кредит, чтобы закрыть другой кредит."),
        Affirmation(text: "Я думаю нам всем нужно чуть-чуть меньше работать, и чуть-чуть больше зарабатывать."),
        Affirmation(text: "Если на мужика нельзя положиться, то и ложиться на него не хочется."),
        Affirmation(text: "Вернуть бы вашу первую встречу. Чтобы сразу послать его нахуй."),
        Affirmation(text: "В этом мире из светлого осталось только пиво."),
        Affirmation(text: "Заживёт."),
        Affirmation(text: "Не истеричка, а потомственная скандалье."),
